...
add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/packaging/kodak.ico ${CMAKE_BINARY_DIR}/package/
    COMMAND ${CMAKE_COMMAND} -E rename ${CMAKE_BINARY_DIR}/package/kodak.ico ${CMAKE_BINARY_DIR}/package/kodak.ico
